...
public class EditoraService {
	...
	public List<Editora> getAllEditoras() {
	 ...
	 public List<EditoraDTO> getAllEditorasDTO(){ 
		...
		//2. Na lista entidade, pegar cada entidade existente nela
		 for (Editora editora: listaEditora) {
			 
		//3. Transformar cada entidade existente na lista em um DTO			
			 EditoraDTO editoraDTO = toDTO(editora);
			 
		//OBS: para converter a entidade no DTO, usar o método toDTO	 
	...
	public ConsultaCnpjDTO consultaCnpjApiExterna (String cnpj) {
		...
		ConsultaCnpjDTO consultaCnpjDTO = restTemplate.getForObject(uri, 
				ConsultaCnpjDTO.class , params);
